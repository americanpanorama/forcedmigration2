...
export default class Map extends React.Component {
  ...
  render() {
    ...
    var projection = d3.geo.azimuthalEquidistant()
      .scale(this.props.dimensions.radius * .318)
      .rotate(DC.map(latlng => latlng * -1))
      .clipAngle(180 - 1e-3)
      .translate([this.props.dimensions.radius,this.props.dimensions.radius])
      .precision(.1);
    ...
    return (
       <g>
          ...
          <text
            x={ this.props.dimensions.radius + 8 }
            y={ this.props.dimensions.radius }
            fill='#eee'
            fillOpacity={0.5}
            fontSize={12}
