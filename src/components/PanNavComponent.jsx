    ...
    return (
      <div>
        ...
        { (!this.props.show_menu) ? 
          <div id='hamburger' style={ DimensionsStore.getHamburgerStyle() }><img src='//dsl.richmond.edu/panorama/static/images/menu-light.svg' onClick={ this.props.on_hamburger_click } /></div> : ''
        }
